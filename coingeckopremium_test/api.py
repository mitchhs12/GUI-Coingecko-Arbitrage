...
from coingeckopremium_test.utils import func_args_preprocessing
...
class CoinGeckoAPI:
    ...
    __API_URL_BASE = "https://pro-api.coingecko.com/api/v3/"

    def __init__(self, api_base_url=__API_URL_BASE, api_key=api_key):
    ...
    def __api_url_params(self, api_url, params, api_url_has_params=False):
        if params:
            ...
            api_url = api_url[:-1]
        api_url = f"{api_url}&x_cg_pro_api_key={self.api_key}"
        # print(api_url)
        return api_url
